...
void InsertNode(){
        ...
        {
            Node*pSearch=pStart;
            while( (pSearch!=nullptr) && ( pSearch->data.getId() < newNode->data.getId() ) )
            ...
            ///Before pStart
             ...
             ///after last
                ...
                newNode->pNext=pSearch;
                newNode->pPrev=pSearch->pPrev;
                pSearch->pPrev->pNext=newNode;
                pSearch->pPrev=newNode;
             }
        }
    }
...
Node* searchNode(int id)
{
    ...
    Node* pSearch = pStart;
    while (pSearch != nullptr && pSearch->data.getId() < id)
            pSearch = pSearch->pNext;
