...
select first_name, is_active, enroll_date
from students
...
select *
from courses 
where course_name ilike '%Systems%' or 
course_name ilike '%Analysis%'
============================================================
-- Q7
select * from students
...
select d.faculty_id, SUM(p.salary)
from departments d
